...
public class AuditSession extends AuditMap implements ISessionObject {
     ...
     *
     */
    public AuditSession(JDBC jdbc, int user_id) {
        super(jdbc, user_id);
    }
     ...
     *
     */
    public AuditSession(JDBC jdbc, String query) {
        super();
        query(jdbc, query);
    }
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new Audit());
    }
     ...
     *
     */
    static public Audit getSelected(HttpServletRequest request) {
        return (Audit) getInstance(request).getSelected();
    }
    ...
    static public AuditSession query(JDBC jdbc, HttpServletRequest request, int user_id, boolean blank) {
        AuditSession session = getInstance(request);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, Audit selected) {
