...
public class ApplicationSession extends ApplicationMap implements ISessionObject {
     ...
     *
     */
    public ApplicationSession(JDBC jdbc, int company_id) {
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new Application());
    }
     ...
     *
     */
    static public Application getSelected(HttpServletRequest request) {
        return (Application) getInstance(request).getSelected();
    }
    ...
    static public ApplicationSession query(JDBC jdbc, HttpServletRequest request, int company_id, boolean blank) {
        ApplicationSession session = getInstance(request);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, Application selected) {
