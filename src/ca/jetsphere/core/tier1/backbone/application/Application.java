...
public class Application extends ca.jetsphere.core.tier0.backbone.application.Application {
     ...
     *
     */
    public Application(JDBC jdbc, int application_id) {
     ...
     *
     */
    public Application(JDBC jdbc, ResultSet rs) throws Exception {
        this();
        get(jdbc, rs);
    }
    ...
    static public String[] captions() {
        return new String[]{"name", "company", "default.period", "default.role", "closed", "last.update", "actions"};
    }
    ...
    public void foreign(JDBC jdbc) throws Exception {
        ...
        setPeriodName(new Period(jdbc, getPeriodId()).getName());
        setRoleName(new Role(jdbc, getRoleId()).getName());
    }
    ...
    public Object get(String s) {
        if ("application_company_id".equals(s)) {
            return getCompany().getName();
        }

        if ("application_period_id".equals(s)) {
            return getPeriodName();
        }

        if ("application_role_id".equals(s)) {
            return getRoleName();
        }
    ...
    public String getPeriodName() {
        return application_period_name;
    }
     ...
     *
     */
    public void setPeriodName(String application_period_name) {
        this.application_period_name = application_period_name;
    }

    public void setRoleName(String application_role_name) {
