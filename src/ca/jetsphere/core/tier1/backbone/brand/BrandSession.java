...
public class BrandSession extends BrandMap implements ISessionObject {
     ...
     *
     */
    public BrandSession(JDBC jdbc, int company_id) {
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new Brand());
    }
     ...
     *
     */
    static public Brand getSelected(HttpServletRequest request) {
        return (Brand) getInstance(request).getSelected();
    }
    ...
    static public BrandSession query(JDBC jdbc, HttpServletRequest request, int company_id, boolean blank) {
        BrandSession session = getInstance(request);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, Brand selected) {
