...
public class EmailSession extends EmailMap implements ISessionObject {
     ...
     *
     */
    public EmailSession(JDBC jdbc, int id) {
        super(jdbc, id);
    }
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new Email());
    }
     ...
     *
     */
    static public Email getSelected(HttpServletRequest request) {
        return (Email) getInstance(request).getSelected();
    }
    ...
    static public EmailSession query(JDBC jdbc, HttpServletRequest request, int email_type_id, boolean blank) {
        EmailSession session = getInstance(request);
        session.find(jdbc, email_type_id);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, Email selected) {
