...
public class CompanyMemberSession extends CompanyMemberMap implements ISessionObject {
     ...
     *
     */
    public CompanyMemberSession(JDBC jdbc, int company_id) {
        this();
     ...
     *
     */
    public CompanyMemberSession(JDBC jdbc, String query) {
        this();
        query(jdbc, query);
    }
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new CompanyMember());
    }
     ...
     *
     */
    static public CompanyMember getSelected(HttpServletRequest request) {
        return (CompanyMember) getInstance(request).getSelected();
    }
    ...
    static public CompanyMemberSession query(JDBC jdbc, HttpServletRequest request, int company_id, boolean blank) {
        CompanyMemberSession session = getInstance(request);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, CompanyMember selected) {
