...
public class PolicySession extends PolicyMap implements ISessionObject {
     ...
     *
     */
    public PolicySession(JDBC jdbc, int company_id) {
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new Policy());
    }
     ...
     *
     */
    static public Policy getSelected(HttpServletRequest request) {
        return (Policy) getInstance(request).getSelected();
    }
    ...
    static public PolicySession query(JDBC jdbc, HttpServletRequest request, int company_id, boolean blank) {
        PolicySession session = getInstance(request);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, Policy selected) {
