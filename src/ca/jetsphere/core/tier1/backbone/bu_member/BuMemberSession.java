...
public class BuMemberSession extends BuMemberMap implements ISessionObject {
     ...
     *
     */
    public BuMemberSession(JDBC jdbc, int bu_id) {
        super(jdbc, bu_id);
    }
     ...
     *
     */
    public BuMemberSession(JDBC jdbc, String query) {
        this();
        query(jdbc, query);
    }
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new BuMember());
    }
     ...
     *
     */
    static public BuMember getSelected(HttpServletRequest request) {
        return (BuMember) getInstance(request).getSelected();
    }
    ...
    static public BuMemberSession query(JDBC jdbc, HttpServletRequest request, int period_id, int bu_id, boolean blank) {
        BuMemberSession session = getInstance(request);
        session.find(jdbc, period_id, bu_id);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, BuMember selected) {
     ...
     *
     */
    public void query(JDBC jdbc, int bu_id) {
        query(jdbc, "select * from os_bu_member where bu_member_bu_id = " + bu_id);
    }
