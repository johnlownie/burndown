...
public class RoleRight extends ca.jetsphere.core.tier0.backbone.role_right.RoleRight {
     ...
     *
     */
    public RoleRight(RoleRight roleRight) {
        this();
        copy(roleRight);
    }
     ...
     *
     */
    public RoleRight(JDBC jdbc, int role_right_id) throws Exception {
        super(jdbc, role_right_id);
    }
    ...
    static public String[] captions() {
        return new String[]{"id", "parent", "name", "action", "href", "ordinal", "hidden", "actions"};
    }
    ...
    static public String[] fields() {
        return new String[]{"role_right_id", "role_right_parent_id", "role_right_name", "role_right_action", "role_right_action_href", "role_right_ordinal", "role_right_hidden", "role_right_uuid"};
    }
    ...
    public Object get(String s) {
        if ("DT_RowId".equals(s)) {
            return getId();
        }

        if ("role_right_name".equals(s)) {
            return getTableName();
        }

        if ("role_right_action".equals(s)) {
            return getAction() != null ? getAction().getName() : "";
        }

        if ("role_right_action_href".equals(s)) {
            return getAction() != null ? getAction().getHref() : "";
        }

        if (s.endsWith("_uuid")) {
            return getActionBox(getUuid());
        }
    ...
    static public void setRoot(JDBC jdbc, Role role) throws Exception {
        RoleRight roleRight = new RoleRight(role);
        roleRight.insert(jdbc);
    }
    ...
    public int getInsertType() {
        return role_right_insert_type;
    }

    /**
     *
     */
    public void setInsertType(int role_right_insert_type) {
        this.role_right_insert_type = role_right_insert_type;
    }
