...
public class RoleRightSession extends RoleRightMap implements ISessionObject {
     ...
     *
     */
    public RoleRightSession(JDBC jdbc, int role_id) {
        this();
        find(jdbc, role_id);
    }
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new RoleRight());
    }
    ...
    public void paste(Tree parent, Tree child) {
        RoleRight p = (RoleRight) parent;
        RoleRight c = (RoleRight) child;
     ...
     *
     */
    static public RoleRight getSelected(HttpServletRequest request) {
        return (RoleRight) getInstance(request).getSelected();
    }
    ...
    static public RoleRightSession query(JDBC jdbc, HttpServletRequest request, int role_id, boolean blank) {
        RoleRightSession session = getInstance(request);
        session.find(jdbc, role_id);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, RoleRight selected) {
