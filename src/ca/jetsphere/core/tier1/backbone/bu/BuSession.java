...
public class BuSession extends BuMap implements ISessionObject {
     ...
     *
     */
    public BuSession(JDBC jdbc, int period_id) {
        this();
        find(jdbc, period_id);
    }
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new Bu());
    }
     ...
     *
     */
    public BuSession getBonsai(BuSession bonsai, List list) {
        return (BuSession) super.getBonsai(bonsai, list);
    }
     ...
     *
     */
    static public Bu getSelected(HttpServletRequest request) {
        return (Bu) getInstance(request).getSelected();
    }
    ...
    static public BuSession query(JDBC jdbc, HttpServletRequest request, int period_id, boolean blank) {
        BuSession session = getInstance(request);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, Bu selected) {
