...
public class NotificationSession extends NotificationMap implements ISessionObject {
     ...
     *
     */
    public NotificationSession(JDBC jdbc, int company_id) {
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new Notification());
    }
     ...
     *
     */
    static public Notification getSelected(HttpServletRequest request) {
        return (Notification) getInstance(request).getSelected();
    }
    ...
    static public NotificationSession query(JDBC jdbc, HttpServletRequest request, int user_id, boolean blank) {
        NotificationSession session = getInstance(request);
        session.find(jdbc, user_id);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, Notification selected) {
