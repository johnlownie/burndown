...
public class Notification extends ca.jetsphere.core.tier0.backbone.notification.Notification {
     ...
     *
     */
    public Notification(JDBC jdbc, int notification_id) {
        super(jdbc, notification_id);
    }
    ...
    static public String[] captions() {
        return new String[]{"user", "type", "icon", "title", "last.update", "actions"};
    }
    ...
    public void delete(JDBC jdbc) throws Exception {
        NotificationReadYard.delete(jdbc, getId());
        super.delete(jdbc);
    }
    ...
    public Object get(String s) {
        if ("notification_user_id".equals(s)) {
            return getUserId() > 0 ? getUsername() : "All Users";
        }
     ...
     *
     */
    public void setUsername(String notification_username) {
