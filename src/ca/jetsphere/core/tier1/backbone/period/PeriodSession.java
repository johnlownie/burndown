...
public class PeriodSession extends PeriodMap implements ISessionObject {
     ...
     *
     */
    public PeriodSession(JDBC jdbc, int application_id) {
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new Period());
    }
     ...
     *
     */
    static public Period getSelected(HttpServletRequest request) {
        return (Period) getInstance(request).getSelected();
    }
    ...
    static public PeriodSession query(JDBC jdbc, HttpServletRequest request, int company_id, int application_id, boolean blank) {
        PeriodSession session = getInstance(request);
        session.find(jdbc, company_id, application_id);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, Period selected) {
