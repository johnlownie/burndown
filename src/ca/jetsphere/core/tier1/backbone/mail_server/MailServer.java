...
public class MailServer extends ca.jetsphere.core.tier0.backbone.mail_server.MailServer {
    ...
    public MailServer(JDBC jdbc) {
        super();
        query(jdbc, "select * from jet_base_mail_server where mail_server_default");
    }

    /**
     *
     */
    public MailServer(JDBC jdbc, int mail_server_id) throws Exception {
        super(jdbc, mail_server_id);
    }
