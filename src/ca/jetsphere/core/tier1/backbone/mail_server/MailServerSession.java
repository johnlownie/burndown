...
public class MailServerSession extends MailServerMap implements ISessionObject {
     ...
     *
     */
    public MailServerSession(JDBC jdbc, int company_id) {
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new MailServer());
    }
     ...
     *
     */
    static public MailServer getSelected(HttpServletRequest request) {
        return (MailServer) getInstance(request).getSelected();
    }
    ...
    static public MailServerSession query(JDBC jdbc, HttpServletRequest request, int company_id, boolean blank) {
        MailServerSession session = getInstance(request);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, MailServer selected) {
