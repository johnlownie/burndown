...
public class NotificationReadSession extends NotificationReadMap implements ISessionObject {
     ...
     *
     */
    public NotificationReadSession() {
        super();
    }
     ...
     *
     */
    public NotificationReadSession(JDBC jdbc, int dummy_id) {
        super(jdbc, dummy_id);
    }
    ...
    public void add(JDBC jdbc, ResultSet rs) throws Exception {
        add(new NotificationRead(jdbc, rs));
    }
    ...
    public void clearSelected(HttpServletRequest request) {
        setNonQualifiedSelected(request, new NotificationRead());
    }
     ...
     *
     */
    static public NotificationRead getSelected(HttpServletRequest request) {
        return (NotificationRead) getInstance(request).getSelected();
    }
    ...
    static public NotificationReadSession query(JDBC jdbc, HttpServletRequest request, int notification_id, boolean blank) {
        NotificationReadSession session = getInstance(request);
        session.find(jdbc, notification_id);
     ...
     *
     */
    static public void setSelected(HttpServletRequest request, NotificationRead selected) {
