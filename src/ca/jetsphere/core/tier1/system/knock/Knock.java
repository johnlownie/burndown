...
public class Knock {
    ...
    static public String get(String s) {
        try {
            ...
            Common.debug("[ Knock ] Not Found: " + s);
            return "";
        }
    }
    ...
    static public String getMessage(String s) {
        try {
            return map.get(s) != null ? (String) map.get(s) : Caption.get(s);
        } catch (Exception e) {
            return "";
        }
    }
     ...
     *
     */
    static public MessageResources getMessageResources() {
        return (MessageResources) map.get("MESSAGE_RESOURCES");
    }
    ...
    static public void set(ServletConfig servletConfig) {
        setInitParameters(servletConfig);
        setInitParameters(servletConfig.getServletContext());
    }
    ...
    static private void setInitParameters(ServletConfig servletConfig) {
        ...
        while (e.hasMoreElements()) {
            ...
            map.put(key, servletConfig.getInitParameter(key));
        }
    }
