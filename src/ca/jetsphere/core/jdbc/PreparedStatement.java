...
public class PreparedStatement {
     ...
     *
     */
    public PreparedStatement(java.sql.Connection connection) {
    ...
    public boolean hasAutoGeneratedColumns() {
        return autoGeneratedColumns != null;
    }
    ...
    public java.sql.PreparedStatement open(String[] autoGeneratedColumns) throws SQLException {
        try {
            return connection.prepareStatement(sql, autoGeneratedColumns);
