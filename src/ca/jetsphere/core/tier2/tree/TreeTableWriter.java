...
public class TreeTableWriter implements Serializable {
     ...
     *
     */
    public TreeTableWriter(TableModel table_model_model) {
    ...
    protected void column(Tree tree, int column) {
        Object o = getModel().getObject(tree, getModel().getField(column));
        String s = "";
    ...
    protected void leaf(Tree tree) {
        write("<tr data-tt-id=\"" + tree.getId() + "\"" + (tree.getParentId() > 0 ? " data-tt-parent-id=\"" + tree.getParentId() + "\"" : "") + ">");
        columns(tree);
        write("</tr>");
    }
