...
public class ActionStore {
    ...
    public ActionStore(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        this.action_store_mapping = mapping;
        this.action_store_form = form;
        this.action_store_request = request;
        this.action_store_response = response;
    }
    ...
    public ActionForward getForward(String forward, String queryString) {
        ActionForward af = getForward(forward);
        return getForward(af, queryString, af.getRedirect());
    }
    ...
    public ActionForm getForm() {
        return action_store_form;
    }

    public ActionMapping getMapping() {
        return this.action_store_mapping;
    }

    public HttpServletRequest getRequest() {
        return this.action_store_request;
    }

    public HttpServletResponse getResponse() {
        return this.action_store_response;
    }

    /**
     *
     */
    public void setForm(ActionForm action_store_form) {
        this.action_store_form = action_store_form;
    }
