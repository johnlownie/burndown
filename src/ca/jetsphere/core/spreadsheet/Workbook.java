...
public class Workbook extends ActionForm {
     ...
     *
     */
    public int getHeaderRow(int cc) {
        return ((Integer) headerRows.get(cc)).intValue();
    }
    ...
    public Sheet getSelectedSheet() {
        return new Sheet(workbook.getSheet(getSelected()));
    }
     ...
     *
     */
    public Sheet getSheet(int cc) {
        return new Sheet(workbook.getSheet(cc));
    }
    ...
    public boolean hasFile() {
        return !DockYard.isWhiteSpace(formFile.getFileName());
    }
    ...
    public void setHeaderRows(String[] checks) {
        ...
        for (int cc = 0; cc < checks.length; cc++) {
            headerRows.add(new Integer(checks[cc]));
        }
    ...
    public void setWorkbook(FormFile file) {
        try {
            ...
            setFile(file);
            setWorkbook(file.getInputStream());
    ...
    public void translate() {
        getSettings().setEncoding(getCharset());
    }
