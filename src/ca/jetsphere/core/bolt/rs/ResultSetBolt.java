...
public class ResultSetBolt extends Bolt {
    ...
    public void copy(Bolt bolt) {
        this.id = ((ResultSetBolt) bolt).getId();
        this.map = ((ResultSetBolt) bolt).getMap();
        this.captions = ((ResultSetBolt) bolt).getCaptions();
    }
