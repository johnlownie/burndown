...
public class ResultSetBoltMap extends BoltMap {
     ...
     *
     */
    public String getCaption(int cc) {
        return captions != null && captions.length > cc ? captions[cc] : "";
    }
    ...
    public BoltComparator getComparator() {
        return new ResultSetComparator();
    }
    ...
    public String getKey() {
        return ResultSetBolt.key();
    }

    /**
     *
     */
    public boolean hasExceptioned() {
