...
abstract public class MetaBolt extends MyActionForm {
    ...
    public Object get(String s) {
        try {
            ...
            if (s.endsWith("_uuid")) {
                return getEditDeleteBox((String) field.get(this));
            }

            if (field.getType() == boolean.class) {
                return get((Boolean) field.get(this));
            }

            if (field.getType() == Timestamp.class) {
                return CalendarYard.getDateFormatDateTimeMedium(locale, (Timestamp) field.get(this));
            }
     ...
     *
     */
    public Object get(String s, Locale locale) {
        setLocale(locale);
        return get(s);
    }
    ...
    protected String getEditCopyDeleteBox(String s) {
        ...
        return "<button type=\"button\" class=\"btn btn-sm btn-default add-tooltip editBtn\" data-toggle=\"tooltip\" data-id=\"" + s + "\" data-original-title=\"Edit\" data-container=\"body\"><i class=\"fa fa-pencil\"></i></button>"
    ...
    protected String getUrl(Integer i) {
        if (DockYard.isWhiteSpace(DockYard.toString(i))) {
            return "";
        }
