...
public class StringHelper
{
    ...
    public static String prepad ( String s, int length ) { return prepad ( s, length, ' ' ); }
    ...
    for ( int i = 0; i < needed; i++ ) sb.append ( c );
    ...
    public static String postpad ( String s, int length ) { return postpad ( s, length, ' ' ); }
    ...
    public static String midpad ( String s, int length ) { return midpad ( s, length, ' ' ); }
    ...
    for ( int i = 0; i < beginning; i++ ) sb.append ( c );

    sb.append ( s );

    for ( int i = 0; i < end; i++ ) sb.append ( c );
    ...
    if ( delimiter == null || ( delimiterLength = delimiter.length () ) == 0 ) return new String[] {s};
    ...
    private static void buildFindAnyPattern ( String[] terms, StringBuilder sb )
    {
