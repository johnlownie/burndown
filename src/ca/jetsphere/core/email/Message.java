...
public class Message extends ActionForm {
    ...
    public void replace(String regex, String replacement) {
        if (!DockYard.isWhiteSpace(getText())) {
    ...
    public void setRecipients() {
        ...
        while (st.hasMoreTokens()) {
            String to = DockYard.trimAll(st.nextToken());
            addRecipient(to);
        }
    ...
    public void setSignature(String message_signature) {
    ...
    public void setTo(String message_to) {
