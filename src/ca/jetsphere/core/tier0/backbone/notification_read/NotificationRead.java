...
public class NotificationRead extends ca.jetsphere.core.tier0.backbone.notification_read.foreign.NotificationRead {
     ...
     *
     */
    public NotificationRead(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getNotificationReadDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getNotificationReadDao().insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getNotificationReadDao().update(jdbc, this);
    }
