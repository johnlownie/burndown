...
public class NotificationReadDao extends AbstractDao {
    ...
    public void insert(JDBC jdbc, Bolt bolt, PreparedStatement ps) throws Exception {
        ...
        notification_read.setUuid(UUID.get());
        notification_read.setCreated(new Timestamp(System.currentTimeMillis()));
        notification_read.setLastUpdate(notification_read.getCreated());
