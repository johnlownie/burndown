...
abstract public class Audit extends Bolt implements IBean {
    ...
    public long getElapsed() {
        return audit_elapsed;
    }

    public Timestamp getLastUpdate() {
        return audit_last_update;
    }
     ...
     *
     */
    public void setId(int audit_id) {
        this.audit_id = audit_id;
    }

    public void setUuid(String audit_uuid) {
        this.audit_uuid = audit_uuid;
    }

    public void setMemberId(int audit_member_id) {
        this.audit_member_id = audit_member_id;
    }

    public void setIp(String audit_ip) {
        this.audit_ip = audit_ip;
    }

    public void setSessionId(String audit_session_id) {
        this.audit_session_id = audit_session_id;
    }

    public void setPath(String audit_path) {
        this.audit_path = audit_path;
    }

    public void setQueryString(String audit_query_string) {
        this.audit_query_string = audit_query_string;
    }

    public void setMethod(String audit_method) {
        this.audit_method = audit_method;
    }

    public void setErrors(String audit_errors) {
        this.audit_errors = audit_errors;
    }

    public void setStart(Timestamp audit_start) {
        this.audit_start = audit_start;
    }

    public void setStop(Timestamp audit_stop) {
        this.audit_stop = audit_stop;
    }

    public void setElapsed(long audit_elapsed) {
        this.audit_elapsed = audit_elapsed;
    }

    public void setLastUpdate(Timestamp audit_last_update) {
        this.audit_last_update = audit_last_update;
    }

    public void setCreated(Timestamp audit_created) {
        this.audit_created = audit_created;
    }
