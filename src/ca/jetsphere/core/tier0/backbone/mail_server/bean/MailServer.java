...
abstract public class MailServer extends Bolt implements IBean {
    ...
    public boolean getTls() {
        return mail_server_tls;
    }

    public boolean getSsl() {
        return mail_server_ssl;
    }

    public boolean getDefault() {
        return mail_server_default;
    }

    public Timestamp getLastUpdate() {
        return mail_server_last_update;
    }

    public Timestamp getCreated() {
        return mail_server_created;
    }
     ...
     *
     */
    public void setId(int mail_server_id) {
        this.mail_server_id = mail_server_id;
    }

    public void setUuid(String mail_server_uuid) {
        this.mail_server_uuid = mail_server_uuid;
    }

    public void setCompanyId(int mail_server_company_id) {
        this.mail_server_company_id = mail_server_company_id;
    }

    public void setHost(String mail_server_host) {
        this.mail_server_host = mail_server_host;
    }

    public void setType(int mail_server_type) {
        this.mail_server_type = mail_server_type;
    }

    public void setPort(int mail_server_port) {
        this.mail_server_port = mail_server_port;
    }

    public void setLogin(String mail_server_login) {
        this.mail_server_login = mail_server_login;
    }

    public void setPassword(String mail_server_password) {
        this.mail_server_password = mail_server_password;
    }

    public void setTls(boolean mail_server_tls) {
        this.mail_server_tls = mail_server_tls;
    }

    public void setSsl(boolean mail_server_ssl) {
        this.mail_server_ssl = mail_server_ssl;
    }

    public void setDefault(boolean mail_server_default) {
        this.mail_server_default = mail_server_default;
    }

    public void setLastUpdate(Timestamp mail_server_last_update) {
        this.mail_server_last_update = mail_server_last_update;
    }

    public void setCreated(Timestamp mail_server_created) {
        this.mail_server_created = mail_server_created;
    }
