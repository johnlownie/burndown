...
abstract public class Role extends Bolt implements IBean {
    ...
    public void setUuid(String role_uuid) {
        this.role_uuid = role_uuid;
    }

    public void setCompanyId(int role_company_id) {
        this.role_company_id = role_company_id;
    }

    public void setType(int role_type) {
        this.role_type = role_type;
    }

    public void setAlias(String role_alias) {
    ...
    public void setNotes(String role_notes) {
        this.role_notes = role_notes;
    }

    public void setReadOnly(boolean role_read_only) {
        this.role_read_only = role_read_only;
    }

    public void setClosure(int role_closure) {
        this.role_closure = role_closure;
    }

    public void setOrdinal(int role_ordinal) {
        this.role_ordinal = role_ordinal;
    }

    public void setLastUpdate(Timestamp role_last_update) {
        this.role_last_update = role_last_update;
    }

    public void setCreated(Timestamp role_created) {
