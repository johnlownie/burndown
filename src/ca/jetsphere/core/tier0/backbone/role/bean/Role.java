...
abstract public class Role extends Bolt implements IBean
{
    ...
    setApplicationId ( ( ( Role ) role ).getApplicationId() );
    ...
    public int       getApplicationId () { return role_application_id ; }
    ...
    setApplicationId ( rs.getInt       ( "role_application_id" ) );
    ...
    public void setApplicationId ( int       role_application_id ) { this.role_application_id = role_application_id ; }
