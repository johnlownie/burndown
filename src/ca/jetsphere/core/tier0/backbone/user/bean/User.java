...
abstract public class User extends Bolt implements IBean {
    ...
    public void copy(Bolt user) {
        ...
        setApplicationId(((User) user).getApplicationId());
    ...
    public void copy(User user) {
        ...
        setApplicationId(user.getApplicationId());
    ...
    public void get(ResultSet rs) throws Exception {
        ...
        setApplicationId(rs.getInt("user_application_id"));
    ...
    public void setUuid(String user_uuid) {
    ...
    public void setStatus(int user_status) {
        this.user_status = user_status;
    }

    public void setLastLogin(Timestamp user_last_login) {
        this.user_last_login = user_last_login;
    }

    public void setRoleIds(String user_role_ids) {
        this.user_role_ids = user_role_ids;
    }

    public void setApplicationId(int user_application_id) {
        this.user_application_id = user_application_id;
    }

    public void setNotes(String user_notes) {
        this.user_notes = user_notes;
    }

    public void setLastUpdate(Timestamp user_last_update) {
        this.user_last_update = user_last_update;
    }

    public void setCreated(Timestamp user_created) {
