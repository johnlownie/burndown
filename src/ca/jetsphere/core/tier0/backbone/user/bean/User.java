...
abstract public class User extends Bolt implements IBean
{
    ...
    public int       getApplicationId () { return user_application_id ; }
    ...
    public void setApplicationId ( int       user_application_id ) { this.user_application_id = user_application_id ; }
