...
abstract public class BuMember extends Bolt implements IBean {
    ...
    public String getUuid() {
        return bu_member_uuid;
    }

    public int getBuId() {
        return bu_member_bu_id;
    }

    public int getCompanyMemberId() {
        return bu_member_company_member_id;
    }

    public String getRoleIds() {
        return bu_member_role_ids;
    }

    public Timestamp getLastUpdate() {
        return bu_member_last_update;
    }

    public Timestamp getCreated() {
        return bu_member_created;
    }
     ...
     *
     */
    public void setId(int bu_member_id) {
        this.bu_member_id = bu_member_id;
    }

    public void setUuid(String bu_member_uuid) {
        this.bu_member_uuid = bu_member_uuid;
    }

    public void setBuId(int bu_member_bu_id) {
        this.bu_member_bu_id = bu_member_bu_id;
    }

    public void setCompanyMemberId(int bu_member_company_member_id) {
        this.bu_member_company_member_id = bu_member_company_member_id;
    }

    public void setRoleIds(String bu_member_role_ids) {
        this.bu_member_role_ids = bu_member_role_ids;
    }

    public void setLastUpdate(Timestamp bu_member_last_update) {
        this.bu_member_last_update = bu_member_last_update;
    }

    public void setCreated(Timestamp bu_member_created) {
        this.bu_member_created = bu_member_created;
    }
