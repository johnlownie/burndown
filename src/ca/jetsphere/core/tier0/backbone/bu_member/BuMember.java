...
public class BuMember extends ca.jetsphere.core.tier0.backbone.bu_member.foreign.BuMember {
     ...
     *
     */
    public BuMember(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getBuMemberDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getBuMemberDao().insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getBuMemberDao().update(jdbc, this);
    }
