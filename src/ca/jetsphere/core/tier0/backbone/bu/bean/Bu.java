...
abstract public class Bu extends Tree implements Comparable {
     ...
     *
     */
    public void setId(int bu_id) {
        this.bu_id = bu_id;
    }

    public void setUuid(String bu_uuid) {
        this.bu_uuid = bu_uuid;
    }

    public void setPeriodId(int bu_period_id) {
        this.bu_period_id = bu_period_id;
    }

    public void setParentId(int bu_parent_id) {
        this.bu_parent_id = bu_parent_id;
    }

    public void setParentUuid(String bu_parent_uuid) {
        this.bu_parent_uuid = bu_parent_uuid;
    }

    public void setDepth(int bu_depth) {
        this.bu_depth = bu_depth;
    }

    public void setLineage(String bu_lineage) {
        this.bu_lineage = bu_lineage;
    }

    public void setOrdinal(int bu_ordinal) {
        this.bu_ordinal = bu_ordinal;
    }

    public void setTypeId(int bu_type_id) {
        this.bu_type_id = bu_type_id;
    }

    public void setName(String bu_name) {
        this.bu_name = bu_name;
    }

    public void setShortName(String bu_short_name) {
        this.bu_short_name = bu_short_name;
    }

    public void setAddress(String bu_address) {
        this.bu_address = bu_address;
    }

    public void setCity(String bu_city) {
        this.bu_city = bu_city;
    }

    public void setProvince(String bu_province) {
        this.bu_province = bu_province;
    }

    public void setPostalCode(String bu_postal_code) {
        this.bu_postal_code = bu_postal_code;
    }

    public void setPhone(String bu_phone) {
        this.bu_phone = bu_phone;
    }

    public void setFax(String bu_fax) {
        this.bu_fax = bu_fax;
    }

    public void setUrl(String bu_url) {
        this.bu_url = bu_url;
    }

    public void setNotes(String bu_notes) {
        this.bu_notes = bu_notes;
    }

    public void setLastUpdate(Timestamp bu_last_update) {
        this.bu_last_update = bu_last_update;
    }

    public void setCreated(Timestamp bu_created) {
        this.bu_created = bu_created;
    }
