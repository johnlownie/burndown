...
abstract public class Application extends Bolt implements IBean {
    ...
    public int getEula() {
        return application_eula;
    }

    public Timestamp getLastUpdate() {
        return application_last_update;
    }
    ...
    public void setUuid(String application_uuid) {
        this.application_uuid = application_uuid;
    }

    public void setCompanyId(int application_company_id) {
        this.application_company_id = application_company_id;
    }

    public void setName(String application_name) {
        this.application_name = application_name;
    }

    public void setNotes(String application_notes) {
        this.application_notes = application_notes;
    }

    public void setDefault(boolean application_default) {
        this.application_default = application_default;
    }

    public void setPeriodId(int application_period_id) {
        this.application_period_id = application_period_id;
    }

    public void setRoleId(int application_role_id) {
        this.application_role_id = application_role_id;
    }

    public void setClosed(boolean application_closed) {
        this.application_closed = application_closed;
    }

    public void setEula(int application_eula) {
        this.application_eula = application_eula;
    }

    public void setLastUpdate(Timestamp application_last_update) {
        this.application_last_update = application_last_update;
    }

    public void setCreated(Timestamp application_created) {
        this.application_created = application_created;
    }
