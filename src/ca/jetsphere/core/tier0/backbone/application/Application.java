...
public class Application extends ca.jetsphere.core.tier0.backbone.application.foreign.Application {
     ...
     *
     */
    public Application(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getApplicationDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getApplicationDao().insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getApplicationDao().update(jdbc, this);
    }
