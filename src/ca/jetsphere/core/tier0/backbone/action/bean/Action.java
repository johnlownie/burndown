...
abstract public class Action extends Bolt implements IBean {
     ...
     *
     */
    public void setId(int action_id) {
        this.action_id = action_id;
    }

    public void setUuid(String action_uuid) {
        this.action_uuid = action_uuid;
    }

    public void setCompanyId(int action_company_id) {
        this.action_company_id = action_company_id;
    }

    public void setName(String action_name) {
        this.action_name = action_name;
    }

    public void setHref(String action_href) {
        this.action_href = action_href;
    }

    public void setToolTip(String action_tooltip) {
        this.action_tooltip = action_tooltip;
    }

    public void setNotes(String action_notes) {
        this.action_notes = action_notes;
    }

    public void setPublic(boolean action_public) {
        this.action_public = action_public;
    }

    public void setLastUpdate(Timestamp action_last_update) {
        this.action_last_update = action_last_update;
    }

    public void setCreated(Timestamp action_created) {
        this.action_created = action_created;
    }
