...
public class Action extends ca.jetsphere.core.tier0.backbone.action.foreign.Action {
     ...
     *
     */
    public Action(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getActionDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getActionDao().insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getActionDao().update(jdbc, this);
    }
