...
abstract public class Email extends Bolt implements IBean {
    ...
    public int getToBuId() {
        return email_to_bu_id;
    }
    ...
    public int getCcBuId() {
        return email_cc_bu_id;
    }
    ...
    public int getBccBuId() {
        return email_bcc_bu_id;
    }
    ...
    public void setUuid(String email_uuid) {
        this.email_uuid = email_uuid;
    }

    public void setTypeId(int email_type_id) {
        this.email_type_id = email_type_id;
    }

    public void setFrom(String email_from) {
        this.email_from = email_from;
    }

    public void setTo(String email_to) {
        this.email_to = email_to;
    }

    public void setPersonal(String email_personal) {
        this.email_personal = email_personal;
    }

    public void setToBuId(int email_to_bu_id) {
        this.email_to_bu_id = email_to_bu_id;
    }

    public void setCc(String email_cc) {
        this.email_cc = email_cc;
    }

    public void setCcBuId(int email_cc_bu_id) {
        this.email_cc_bu_id = email_cc_bu_id;
    }

    public void setBcc(String email_bcc) {
        this.email_bcc = email_bcc;
    }

    public void setBccBuId(int email_bcc_bu_id) {
        this.email_bcc_bu_id = email_bcc_bu_id;
    }

    public void setSubject(String email_subject) {
        this.email_subject = email_subject;
    }

    public void setMessage(String email_message) {
        this.email_message = email_message;
    }

    public void setAttachment(String email_attachment) {
        this.email_attachment = email_attachment;
    }

    public void setStatusId(int email_status_id) {
        this.email_status_id = email_status_id;
    }

    public void setLastUpdate(Timestamp email_last_update) {
        this.email_last_update = email_last_update;
    }

    public void setCreated(Timestamp email_created) {
