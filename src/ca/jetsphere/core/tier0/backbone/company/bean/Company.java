...
abstract public class Company extends Bolt implements IBean {
    ...
    public void setUuid(String company_uuid) {
    ...
    public void setShort(String company_short) {
        this.company_short = company_short;
    }

    public void setStreet(String company_street) {
    ...
    public void setProvince(String company_province) {
        this.company_province = company_province;
    }

    public void setPostalCode(String company_postal_code) {
    ...
    public void setFax(String company_fax) {
        this.company_fax = company_fax;
    }

    public void setUrl(String company_url) {
    ...
    public void setDefault(boolean company_default) {
        this.company_default = company_default;
    }

    public void setLastUpdate(Timestamp company_last_update) {
        this.company_last_update = company_last_update;
    }

    public void setCreated(Timestamp company_created) {
