...
abstract public class Period extends Bolt implements IBean {
    ...
    public void setUuid(String period_uuid) {
        this.period_uuid = period_uuid;
    }

    public void setApplicationId(int period_application_id) {
        this.period_application_id = period_application_id;
    }

    public void setName(String period_name) {
        this.period_name = period_name;
    }

    public void setCode(String period_code) {
        this.period_code = period_code;
    }

    public void setStartDate(Date period_start_date) {
        this.period_start_date = period_start_date;
    }

    public void setEndDate(Date period_end_date) {
        this.period_end_date = period_end_date;
    }

    public void setNotes(String period_notes) {
        this.period_notes = period_notes;
    }

    public void setTypeId(int period_type_id) {
        this.period_type_id = period_type_id;
    }

    public void setOrdinal(int period_ordinal) {
        this.period_ordinal = period_ordinal;
    }

    public void setClosed(boolean period_closed) {
        this.period_closed = period_closed;
    }

    public void setLastUpdate(Timestamp period_last_update) {
        this.period_last_update = period_last_update;
    }

    public void setCreated(Timestamp period_created) {
        this.period_created = period_created;
    }
