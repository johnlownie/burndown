...
public class Period extends ca.jetsphere.core.tier0.backbone.period.foreign.Period {
     ...
     *
     */
    public Period(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getPeriodDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getPeriodDao().insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getPeriodDao().update(jdbc, this);
    }
