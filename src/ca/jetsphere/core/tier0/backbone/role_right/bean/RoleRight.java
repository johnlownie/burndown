...
abstract public class RoleRight extends Tree {
    ...
    public String getUuid() {
        return role_right_uuid;
    }

    public int getRoleId() {
        return role_right_role_id;
    }

    public int getParentId() {
        return role_right_parent_id;
    }

    public String getParentUuid() {
        return role_right_parent_uuid;
    }

    public int getDepth() {
        return role_right_depth;
    }

    public String getLineage() {
        return role_right_lineage;
    }

    public int getOrdinal() {
        return role_right_ordinal;
    }

    public String getName() {
        return role_right_name;
    }

    public int getActionId() {
        return role_right_action_id;
    }

    public boolean getHidden() {
        return role_right_hidden;
    }

    public String getNotes() {
        return role_right_notes;
    }

    public Timestamp getLastUpdate() {
        return role_right_last_update;
    }

    public Timestamp getCreated() {
        return role_right_created;
    }

    /**
     *
     */
    public void setId(int role_right_id) {
        this.role_right_id = role_right_id;
    }

    public void setUuid(String role_right_uuid) {
        this.role_right_uuid = role_right_uuid;
    }

    public void setRoleId(int role_right_role_id) {
        this.role_right_role_id = role_right_role_id;
    }

    public void setParentId(int role_right_parent_id) {
        this.role_right_parent_id = role_right_parent_id;
    }

    public void setParentUuid(String role_right_parent_uuid) {
        this.role_right_parent_uuid = role_right_parent_uuid;
    }

    public void setDepth(int role_right_depth) {
        this.role_right_depth = role_right_depth;
    }

    public void setLineage(String role_right_lineage) {
        this.role_right_lineage = role_right_lineage;
    }

    public void setOrdinal(int role_right_ordinal) {
        this.role_right_ordinal = role_right_ordinal;
    }

    public void setName(String role_right_name) {
        this.role_right_name = role_right_name;
    }

    public void setActionId(int role_right_action_id) {
        this.role_right_action_id = role_right_action_id;
    }

    public void setHidden(boolean tree_collapsed) {
        this.role_right_hidden = tree_collapsed;
    }

    public void setNotes(String role_right_notes) {
        this.role_right_notes = role_right_notes;
    }

    public void setLastUpdate(Timestamp role_right_last_update) {
        this.role_right_last_update = role_right_last_update;
    }

    public void setCreated(Timestamp role_right_created) {
        this.role_right_created = role_right_created;
    }
