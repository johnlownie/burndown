...
abstract public class Brand extends Bolt implements IBean {
    ...
    public void setUuid(String brand_uuid) {
        this.brand_uuid = brand_uuid;
    }

    public void setCompanyId(int brand_company_id) {
        this.brand_company_id = brand_company_id;
    }
    ...
    public void setUrl(String brand_url) {
    ...
    public void setBackground(String brand_background) {
        this.brand_background = brand_background;
    }

    public void setCopyright(String brand_copyright) {
        this.brand_copyright = brand_copyright;
    }

    public void setDefault(boolean brand_default) {
        this.brand_default = brand_default;
    }

    public void setLastUpdate(Timestamp brand_last_update) {
        this.brand_last_update = brand_last_update;
    }

    public void setCreated(Timestamp brand_created) {
