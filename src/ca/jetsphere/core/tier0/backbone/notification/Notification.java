...
public class Notification extends ca.jetsphere.core.tier0.backbone.notification.foreign.Notification {
     ...
     *
     */
    public Notification(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getNotificationDao().delete(jdbc, this);
    }
    ...
    public String getUntilAsString() {
        return CalendarYard.getDateTimeFormat(getUntil(), "yyyy-MM-dd");
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getNotificationDao().insert(jdbc, this);
    }

    /**
     *
     */
    public void setUntilAsString(String date) {
        setUntil(CalendarYard.getDate(date, "yyyy-MM-dd"));
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getNotificationDao().update(jdbc, this);
    }
