...
abstract public class Notification extends Bolt implements IBean {
    ...
    public Timestamp getLastUpdate() {
        return notification_last_update;
    }
    ...
    public void setUuid(String notification_uuid) {
    ...
    public void setIcon(String notification_icon) {
        this.notification_icon = notification_icon;
    }

    public void setTitle(String notification_title) {
        this.notification_title = notification_title;
    }

    public void setMessage(String notification_message) {
        this.notification_message = notification_message;
    }

    public void setContainer(String notification_container) {
        this.notification_container = notification_container;
    }

    public void setTimer(int notification_timer) {
        this.notification_timer = notification_timer;
    }

    public void setUserId(int notification_user_id) {
        this.notification_user_id = notification_user_id;
    }

    public void setRoleId(int notification_role_id) {
        this.notification_role_id = notification_role_id;
    }

    public void setBuId(int notification_bu_id) {
        this.notification_bu_id = notification_bu_id;
    }

    public void setHref(String notification_href) {
        this.notification_href = notification_href;
    }

    public void setUntil(Date notification_until) {
        this.notification_until = notification_until;
    }

    public void setActive(boolean notification_active) {
        this.notification_active = notification_active;
    }

    public void setLastUpdate(Timestamp notification_last_update) {
        this.notification_last_update = notification_last_update;
    }

    public void setCreated(Timestamp notification_created) {
