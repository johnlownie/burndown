...
public class CompanyMember extends ca.jetsphere.core.tier0.backbone.company_member.foreign.CompanyMember {
     ...
     *
     */
    public CompanyMember(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getCompanyMemberDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getCompanyMemberDao().insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getCompanyMemberDao().update(jdbc, this);
    }
