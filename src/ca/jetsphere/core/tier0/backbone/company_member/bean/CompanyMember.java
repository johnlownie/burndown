...
abstract public class CompanyMember extends Bolt implements IBean {
    ...
    public String getUuid() {
        return company_member_uuid;
    }

    public int getUserId() {
        return company_member_user_id;
    }

    public int getCompanyId() {
        return company_member_company_id;
    }

    public String getFirstname() {
        return company_member_firstname;
    }

    public String getLastname() {
        return company_member_lastname;
    }

    public String getStreet() {
        return company_member_street;
    }

    public String getCity() {
        return company_member_city;
    }

    public String getProvince() {
        return company_member_province;
    }

    public String getPostalCode() {
        return company_member_postal_code;
    }

    public String getHomePhone() {
        return company_member_home_phone;
    }

    public String getMobilePhone() {
        return company_member_mobile_phone;
    }

    public String getWorkPhone() {
        return company_member_work_phone;
    }

    public String getWorkFax() {
        return company_member_work_fax;
    }

    public String getEmail() {
        return company_member_email;
    }

    public int getAvatarId() {
        return company_member_avatar_id;
    }

    public boolean getSubscribed() {
        return company_member_subscribed;
    }

    public Timestamp getLastUpdate() {
        return company_member_last_update;
    }

    public Timestamp getCreated() {
        return company_member_created;
    }
     ...
     *
     */
    public void setId(int company_member_id) {
        this.company_member_id = company_member_id;
    }

    public void setUuid(String company_member_uuid) {
        this.company_member_uuid = company_member_uuid;
    }

    public void setUserId(int company_member_user_id) {
        this.company_member_user_id = company_member_user_id;
    }

    public void setCompanyId(int company_member_company_id) {
        this.company_member_company_id = company_member_company_id;
    }

    public void setFirstname(String company_member_firstname) {
        this.company_member_firstname = company_member_firstname;
    }

    public void setLastname(String company_member_lastname) {
        this.company_member_lastname = company_member_lastname;
    }

    public void setStreet(String company_member_street) {
        this.company_member_street = company_member_street;
    }

    public void setCity(String company_member_city) {
        this.company_member_city = company_member_city;
    }

    public void setProvince(String company_member_province) {
        this.company_member_province = company_member_province;
    }

    public void setPostalCode(String company_member_postal_code) {
        this.company_member_postal_code = company_member_postal_code;
    }

    public void setHomePhone(String company_member_home_phone) {
        this.company_member_home_phone = company_member_home_phone;
    }

    public void setWorkPhone(String company_member_work_phone) {
        this.company_member_work_phone = company_member_work_phone;
    }

    public void setMobilePhone(String company_member_mobile_phone) {
        this.company_member_mobile_phone = company_member_mobile_phone;
    }

    public void setWorkFax(String company_member_work_fax) {
        this.company_member_work_fax = company_member_work_fax;
    }

    public void setEmail(String company_member_email) {
        this.company_member_email = company_member_email;
    }

    public void setAvatarId(int company_member_avatar_id) {
        this.company_member_avatar_id = company_member_avatar_id;
    }

    public void setSubscribed(boolean company_member_subscribed) {
        this.company_member_subscribed = company_member_subscribed;
    }

    public void setLastUpdate(Timestamp company_member_last_update) {
        this.company_member_last_update = company_member_last_update;
    }

    public void setCreated(Timestamp company_member_created) {
        this.company_member_created = company_member_created;
    }
