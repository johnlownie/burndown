...
abstract public class Token extends Bolt implements IBean {
    ...
    public void setUuid(String token_uuid) {
        this.token_uuid = token_uuid;
    }

    public void setIdentifier(int token_identifier) {
        this.token_identifier = token_identifier;
    }

    public void setExpiry(Timestamp token_expiry) {
        this.token_expiry = token_expiry;
    }

    public void setLastUpdate(Timestamp token_last_update) {
        this.token_last_update = token_last_update;
    }

    public void setCreated(Timestamp token_created) {
