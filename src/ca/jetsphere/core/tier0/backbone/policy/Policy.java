...
public class Policy extends ca.jetsphere.core.tier0.backbone.policy.foreign.Policy {
     ...
     *
     */
    public Policy(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getPolicyDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getPolicyDao().insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getPolicyDao().update(jdbc, this);
    }
