...
abstract public class Policy extends Bolt implements IBean {
    ...
    public void setUuid(String policy_uuid) {
        this.policy_uuid = policy_uuid;
    }

    public void setCompanyId(int policy_company_id) {
        this.policy_company_id = policy_company_id;
    }
    ...
    public void setValue(int policy_value) {
        this.policy_value = policy_value;
    }

    public void setLastUpdate(Timestamp policy_last_update) {
        this.policy_last_update = policy_last_update;
    }

    public void setCreated(Timestamp policy_created) {
        this.policy_created = policy_created;
    }
