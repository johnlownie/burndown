...
abstract public class MyActionForm extends ActionForm {
    ...
    public void clear(String key, HttpServletRequest request) {
        getActionForm(key, request).clear();
    }

    static MyActionForm getActionForm(String key, HttpServletRequest request) {
        return (MyActionForm) request.getSession().getAttribute(getActionFormName(key));
    }

    static public String getActionFormName(String key) {
        return "[" + key + "]";
    }
     ...
     *
     */
    public void setRequest(MyActionForm af) {
        setRequest(af.getRequest());
    }
    ...
    public void setSelected(HttpServletRequest request, String key) {
        request.getSession().setAttribute(key, "" + getId());
        request.getSession().setAttribute(getActionFormName(key), this);
    }
