...
public class Common {
    ...
    static public Appender getAppender(String logger, String appender) {
        try {
            return org.apache.log4j.Logger.getLogger(logger).getAppender(appender);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    static public String getLogFile(String logger, String appender) {
        try {
            return ((DailyRollingFileAppender) getAppender(logger, appender)).getFile();
        } catch (Exception e) {
            return "";
        }
    }
    ...
    static public String getLogPath() {
        try {
            File file = new File(getLogFile("ca.jetsphere", "dest2"));
    ...
    static public void json(HttpServletResponse response, String message) {
        try {
            ...
            jsonObject.put("message", Caption.get(response.getLocale(), message));
    ...
    static public void trace(HttpServletRequest request) {
        ...
        while (e.hasMoreElements()) {
            logger.fatal(((String) e.nextElement()));
        }
