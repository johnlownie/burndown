...
public class DockYard {
    ...
    static public String caption(HttpServletRequest request, String s) {
        ...
        String original = s;
        String substituted = s.toLowerCase().replaceAll("'", ".").replaceAll(" ", ".").replaceAll("&nbsp;", ".").replaceAll("/", ".").replaceAll("-", ".").replaceAll(":", "");
     ...
     */
    static public boolean contains(String[] s1, String s2) {
        if (isWhiteSpace(s1) || isWhiteSpace(s2) || s1.length == 0) {
            return false;
        }

        for (int cc = 0; cc < s1.length; cc++) {
            if (compareTo(s1[cc], s2) == 0) {
                return true;
            }
        }
     ...
     */
    static public boolean contains(String s1, String[] s2) {
        if (isWhiteSpace(s1) || isWhiteSpace(s2) || s2.length == 0) {
            return false;
        }
     ...
     *
     */
    static public boolean equals(int i1, int i2) {
        return i1 == i2;
    }
     ...
     *
     */
    static public String getHref(String url) {
        return getHref(url, url, true);
    }
    ...
    static public int getObjectSize(Object o) {
        ...
        try {
            ...
            if (ns.getClass().getName().startsWith("com.jet") || ns.getClass().getName().startsWith("com.blue7")) {
                Common.trace(ns);
            }
            return 0;
    ...
    static public String getOptions(HttpServletRequest request, List<String> list, String selected, String blank) {
        ...
        if (!isWhiteSpace(blank)) {
            sb.append("<option value=\"\">" + Caption.get(request, blank) + "</option>");
        }
    ...
    static public String getOptions(HttpServletRequest request, BoltMap boltMap, Comparator comparator, int selected, String blank) {
        ...
        while (it.hasNext()) {
            ...
            sb.append("<option value=\"" + bolt.getId() + "\" " + (selected == bolt.getId() ? " selected=\"selected\"" : "") + ">" + bolt.getName() + "</option>");
        }
     ...
     *
     */
    static public int getTokenCount(String s) {
    ...
    static public boolean isInsertUpdateDelete(String s) {
        s = s.toLowerCase();
        return s.indexOf("insert ") >= 0 || s.indexOf("update ") >= 0 || s.indexOf("delete ") >= 0;
    }
    ...
    static public boolean isWhiteSpace(String s) {
        return s == null || trimAll(s).length() == 0;
    }
    ...
    static public boolean isWhiteSpace(HttpServletRequest request, String s) {
        ...
        try {
            if (!isWhiteSpace(request.getParameter(st.nextToken()))) {
                return false;
            }
        } catch (Exception e) {
            return true;
     ...
     *
     */
    static public String join(String[] s) {
        return join(s, ",");
    }
     ...
     *
     */
    static public int toInteger(Integer i) {
        return i.intValue();
    }
     ...
     *
     */
    static public int toInteger(BigDecimal bd) {
        return bd.intValue();
    }
     ...
     *
     */
    static public int toInteger(Boolean b) {
     ...
     *
     */
    static public int toInteger(Double d) {
        return d.intValue();
    }
     ...
     *
     */
    static public int toInteger(Long l) {
        return l.intValue();
    }
    ...
    static public String zeroPad(String s, int width) {
        ...
        for (int cc = 0; cc < width - s.length(); cc++) {
            sb.append("0");
        }
