...
public class Category extends ca.jetsphere.burndown.tier0.backbone.category.Category {
    ...
    public Category(JDBC jdbc) {
        super();
        query(jdbc, "select * from jet_burndown_category");
    }

    /**
     *
     */
    public Category(JDBC jdbc, int category_id) throws Exception {
        super(jdbc, category_id);
    }
    ...
    public Category(Application application) {
        ...
        setParentId(0);
        setParentUuid(application.getUuid());
    ...
    static public String[] captions() {
        return new String[]{"id", "parent", "category.name", "category.included", "category.fixed", "actions"};
    }
    ...
    static public String[] fields() {
        return new String[]{"category_id", "category_parent_id", "category_name", "category_included", "category_fixed", "category_uuid"};
    }
    ...
    static public void setRoot(JDBC jdbc, Application application) throws Exception {
        Category category = new Category(application);
        category.insert(jdbc);
    }
     ...
     *
     */
    public void setInsertType(int category_insert_type) {
        this.category_insert_type = category_insert_type;
    }
}
