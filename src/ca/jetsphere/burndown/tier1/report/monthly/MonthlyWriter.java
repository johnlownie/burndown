...
public class MonthlyWriter extends TableWriter {
    ...
    public MonthlyWriter(BoltMap bolts, String[] captions, String[] fields, String report_type) {
        super(bolts, captions, fields);
        setType(report_type);
        setTotal(new int[captions.length]);
    }
    ...
    protected void footer() {
        write("<tfoot class=\"bg-gray text-bold\">");
        /* write ( getTotals() ); */ write("</tfoot>");
    }
    ...
    public void format(int row, int column) {
        ...
        write("<td>");
        write(c != 0 ? DockYard.toMoney(DockYard.toInt(c)) : "");
        write("</td>");
    }
     ...
     *
     */
    public void setTotal(int[] column_total) {
        this.column_total = column_total;
    }

    public void setType(String report_type) {
