...
public class Registry extends ca.jetsphere.core.tier0.Registry {
    ...
    static public void get(JDBC jdbc, Bolt bolt, int id) {
        bolt.query(jdbc, "select * from jet_burndown_" + bolt.getKey() + " where " + bolt.getKey() + "_id = " + id);
    }
    ...
    public static AccountDao getAccountDao() {
        return (AccountDao) context.getBean("account", AccountDao.class);
    }

    public static CategoryDao getCategoryDao() {
        return (CategoryDao) context.getBean("category", CategoryDao.class);
    }

    public static TransactionDao getTransactionDao() {
        return (TransactionDao) context.getBean("transaction", TransactionDao.class);
    }
}
