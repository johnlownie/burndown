...
abstract public class Transaction extends Bolt implements IBean {
    ...
    public void setPeriodId(int transaction_period_id) {
        this.transaction_period_id = transaction_period_id;
    }

    public void setAccountId(int transaction_account_id) {
        this.transaction_account_id = transaction_account_id;
    }

    public void setCategoryId(int transaction_category_id) {
        this.transaction_category_id = transaction_category_id;
    }

    public void setName(String transaction_name) {
        this.transaction_name = transaction_name;
    }

    public void setType(int transaction_type) {
        this.transaction_type = transaction_type;
    }

    public void setAmount(int transaction_amount) {
        this.transaction_amount = transaction_amount;
    }

    public void setMemo(String transaction_memo) {
        this.transaction_memo = transaction_memo;
    }

    public void setFitId(String transaction_fitid) {
        this.transaction_fitid = transaction_fitid;
    }
    ...
    public void setLastUpdate(Timestamp transaction_last_update) {
        this.transaction_last_update = transaction_last_update;
    }

    public void setCreated(Timestamp transaction_created) {
        this.transaction_created = transaction_created;
    }
}
