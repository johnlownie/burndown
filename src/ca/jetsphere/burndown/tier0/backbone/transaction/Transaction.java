...
public class Transaction extends ca.jetsphere.burndown.tier0.backbone.transaction.foreign.Transaction {
     ...
     *
     */
    public Transaction(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getTransactionDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        Registry.getTransactionDao().insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getTransactionDao().update(jdbc, this);
    }
}
