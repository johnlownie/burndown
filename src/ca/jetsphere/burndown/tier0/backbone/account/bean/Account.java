...
abstract public class Account extends Bolt implements IBean {
    ...
    public void setUuid(String account_uuid) {
        this.account_uuid = account_uuid;
    }

    public void setApplicationId(int account_application_id) {
    ...
    public void setSecondary(String account_secondary) {
        this.account_secondary = account_secondary;
    }

    public void setBankId(String account_bank_id) {
        this.account_bank_id = account_bank_id;
    }

    public void setUrl(String account_url) {
        this.account_url = account_url;
    }

    public void setLastUpdate(Timestamp account_last_update) {
        this.account_last_update = account_last_update;
    }

    public void setCreated(Timestamp account_created) {
