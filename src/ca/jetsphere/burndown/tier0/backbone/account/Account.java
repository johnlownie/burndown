...
public class Account extends ca.jetsphere.burndown.tier0.backbone.account.foreign.Account {
     ...
     *
     */
    public Account(JDBC jdbc, int id) {
    ...
    public void delete(JDBC jdbc) throws Exception {
        Registry.getAccountDao().delete(jdbc, this);
    }
    ...
    public void insert(JDBC jdbc) throws Exception {
        AccountDao accountDao = Registry.getAccountDao();
        accountDao.insert(jdbc, this);
    }
    ...
    public boolean update(JDBC jdbc) throws Exception {
        return Registry.getAccountDao().update(jdbc, this);
    }
}
