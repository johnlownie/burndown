...
abstract public class Category extends Tree {
    ...
    public int getApplicationId() {
        return category_application_id;
    }
    ...
    public void setUuid(String category_uuid) {
        this.category_uuid = category_uuid;
    }

    public void setApplicationId(int category_application_id) {
        this.category_application_id = category_application_id;
    }

    public void setParentId(int category_parent_id) {
        this.category_parent_id = category_parent_id;
    }

    public void setParentUuid(String category_parent_uuid) {
        this.category_parent_uuid = category_parent_uuid;
    }

    public void setDepth(int category_depth) {
        this.category_depth = category_depth;
    }

    public void setLineage(String category_lineage) {
        this.category_lineage = category_lineage;
    }

    public void setOrdinal(int category_ordinal) {
        this.category_ordinal = category_ordinal;
    }
    ...
    public void setIncluded(Boolean category_included) {
        this.category_included = category_included;
    }

    public void setFixed(Boolean category_fixed) {
        this.category_fixed = category_fixed;
    }

    public void setStatic(Boolean category_static) {
        this.category_static = category_static;
    }

    public void setLastUpdate(Timestamp category_last_update) {
        this.category_last_update = category_last_update;
    }

    public void setCreated(Timestamp category_created) {
