...
<link rel="stylesheet" type="text/css" href="plugins/dropzone/dropzone.min.css" media="all"/>
<link rel="stylesheet" type="text/css" href="plugins/dropzone/dropzone.theme.min.css" media="all"/>
