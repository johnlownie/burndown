...
<script type="text/javascript" src="js/jquery/burndown/table/jquery.table.import.js"></script>
<script type="text/javascript" src="js/jquery/core/table/jquery.table.import.js"></script>
